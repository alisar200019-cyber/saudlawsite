...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (nav) {
    ...
    if (!existingConsultButton) {
      ...
      consultButton.setAttribute('aria-label', 'احجز استشارتك');
  ...
  if (!floatingGroup) {
    ...
    floatingGroup.className = 'floating-contact-group';
  ...
  if (!floatingGroup.querySelector('.floating-call')) {
    ...
    callButton.href = 'tel:+966557776043';
